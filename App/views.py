...
from App import db
from App.models import SavedMovies, WatchedMovies
from App.search_movie import (
    Similar,
    UpComingMovies,
    PopularMovies,
    SearchVideos,
...
def upComing_list():
    ...
    return render_template(
        "upcoming_list.html", movies=upcoming_movies, current_page=page
    )
